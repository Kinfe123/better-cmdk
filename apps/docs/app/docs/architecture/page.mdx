...
Architecture is the starting point for related workflows in better cmdk. Choose the page that matches the workflow, integration, or reference surface you need, then follow its setup and verification guidance.
